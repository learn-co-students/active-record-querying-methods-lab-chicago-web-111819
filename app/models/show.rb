class Show < ActiveRecord::Base
    ...
    # value in the ratings column. hint: if there is a minimum 
    # Active Record method, might there be a maximum method?
    def self.highest_rating
        Show.maximum(:rating)
    end
    # # most_popular_show: this method should return the show 
    # with the highest rating. hint: use the highest_rating method as a 
    # helper method.
    ...
    # # popular_shows: returns an array of all of the shows that 
